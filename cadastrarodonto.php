                        ...
                        <div class="w-form">
                            ...
                            try{
                                ...
                                if($contar>0){
                                    while($show = $resultSel->FETCH(PDO::FETCH_OBJ)){
                                        $id = $show->id_odonto;
                                        $nome = $show->cliente_odonto;
                                        $doutor = $show->prof_odonto;
                                        $preco = $show->preco_odonto;
                                        $data = $show->data_odonto;
                            ...
                            <?php
                                              if(isset($_POST['btnEditar'])){
                                                ...
                                                $editar = "UPDATE tb_odonto SET cliente_odonto=:nomeCl,prof_odonto=
                                                :doutorCl,preco_odonto=:precoCl,data_odonto=:dataCl,andar_odonto=:andarCl, WHERE 
                                                id_odonto=:id";
                                                try{
